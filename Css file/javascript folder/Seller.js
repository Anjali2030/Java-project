function validation() {
    ...
    /*customer_id*/
    if (id == "") {
        document.getElementById('cii').innerHTML = "*Please write Id in box";
        return false;
   ...
   /*customer name*/  
    ...
    if (name == "") {
        document.getElementById('snn').innerHTML = "*Please write username in box";
        return false;

    }
    if (name.length <= 2) {
        document.getElementById('snn').innerHTML = "*Please write more than one character";
        return false;

    }
    if (!isNaN(name)) {
        document.getElementById('snn').innerHTML = "*Please write alphabet only";
        return false;

    } 
    else {
        document.getElementById('snn').innerHTML = "";
    }
