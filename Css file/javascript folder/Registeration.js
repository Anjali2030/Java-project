function validation() {
    ...
    if (user == "") {
        document.getElementById('unn').innerHTML = "*Please write username in box";
        return false;

    }
    if (user.length <= 2) {
        document.getElementById('unn').innerHTML = "*Please write more than one character";
        return false;

    }
    if (!isNaN(user)) {
        document.getElementById('unn').innerHTML = "*Please write alphabet only";
        return false;
    ...
    if (password.length < 5) {
        document.getElementById('passs').innerHTML = "*Please write atleast 5 character password";
        return false;
    }

    if (password.search(/[0-9]/) == -1) {
        document.getElementById('passs').innerHTML = "*Please write atleast 1 numeric character password";
        return false;
    }
    if (password.search(/[!@#$%^&*(+<>:"_?")]/) == -1) {
        document.getElementById('passs').innerHTML = "*Please write atleast 1 special character password";
        return false;
    } else {
